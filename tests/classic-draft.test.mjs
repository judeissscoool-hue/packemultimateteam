...
import {createClassicSession,validateTranscript,CLASSIC_RULES_VERSION,ALL_SLOTS,publicCard} from '../supabase/functions/_shared/atu-engine-ratings-20260920.js';
