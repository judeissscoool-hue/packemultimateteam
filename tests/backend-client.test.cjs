...
async function run() {
  ...
  for (const rulesVersion of ["atu-v1", "atu-classic-v2", "atu-classic-v3", "atu-history-draft-v1", "atu-classic-v4", "atu-history-draft-v2"]) {
    const router = await import('../supabase/functions/_shared/atu-engine-pool-20260920.js');
  ...
  }
  {
    ...
    const engine=await import('../supabase/functions/_shared/atu-engine-pool-20260920.js');
...

  {
    ...
    const engine=await import('../supabase/functions/_shared/atu-engine-pool-20260920.js');let submissions=0, fail=true;
