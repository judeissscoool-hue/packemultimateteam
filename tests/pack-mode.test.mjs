...
import {createClassicPackSession,createClassicSession,validateTranscript,PACK_RULES_VERSION,CLASSIC_RULES_VERSION,ALL_SLOTS,publicCard} from '../supabase/functions/_shared/atu-engine-ratings-20260920.js';
