...
('atu-classic-v5','atu-roster-v1',true),
('atu-pack-v5','atu-roster-v1',true),
('atu-history-draft-v3','atu-roster-v1',true),
('atu-history-pack-v3','atu-roster-v1',true)
...
begin
  foreach signature in array array[
    ...
    if signature like '%fairness%' or signature like '%exposure%' then
      old_list := '(''atu-classic-v4'',''atu-history-draft-v2'')';
      new_list := '(''atu-classic-v4'',''atu-history-draft-v2'',''atu-classic-v5'',''atu-history-draft-v3'')';
    else
      old_list := '(''atu-classic-v2'', ''atu-classic-v3'', ''atu-history-draft-v1'', ''atu-classic-v4'', ''atu-history-draft-v2'')';
      new_list := '(''atu-classic-v2'', ''atu-classic-v3'', ''atu-history-draft-v1'', ''atu-classic-v4'', ''atu-history-draft-v2'', ''atu-classic-v5'', ''atu-history-draft-v3'')';
    end if;
  ...
  if (select count(*) from public.rulesets where version in ('atu-classic-v5','atu-pack-v5','atu-history-draft-v3','atu-history-pack-v3') and validator_version='atu-roster-v1' and enabled)<>4 then
