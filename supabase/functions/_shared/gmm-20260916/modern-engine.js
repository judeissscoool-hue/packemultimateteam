...
import { CARDS, DUOS } from "../gmm-20260913/modern-data.js";

export const ENGINE_VERSION = "atu-gmm-v2";
export const RULES_VERSION = "atu-v1";
export const CLASSIC_RULES_VERSION = "atu-classic-v4";
export const PACK_RULES_VERSION = "atu-pack-v4";
