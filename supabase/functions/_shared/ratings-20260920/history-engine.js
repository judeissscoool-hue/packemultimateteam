...
import { CARDS, DUOS } from "./history-data.js";

export const ENGINE_VERSION = "atu-ratings-v1";
export const RULES_VERSION = "atu-v1";
export const CLASSIC_RULES_VERSION = "atu-history-draft-v6";
export const PACK_RULES_VERSION = "atu-history-pack-v6";
...
function projectWins(effectiveRating) {
  ...
  for (let i = 0; i < PROJECTION_POINTS.length - 1; i++) {
    ...
    if (rating <= b) {
      ...
      // Linear below 80 wins avoids repeated flat spots at every anchor.
      // Preserve the calibrated 80–82 segment and its exact perfection boundary.
