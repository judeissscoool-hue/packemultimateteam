...
import * as modern from './pool-20260920/modern-engine.js';
import * as history from './pool-20260920/history-engine.js';
...
function poolForRules(version) { return [history,priorHistory,previousHistory,septemberHistory,finalHistory].includes(engines.get(version))?'history':engines.get(version)===legacy?'legacy':'modern'; }
